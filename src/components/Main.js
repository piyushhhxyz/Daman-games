...
const Main = () => {
  return (
    <div className='main'>
      ...
      <img className='imadge' src="https://www.f6s.com/content-resource/media/5132199_61a9bd388999b2f637d158cd7aa71d1f5d422ddd_large.png" alt="logo" style={{ width: '500px', height: '300px' }} />
